...
begin
	...
	if(yPixel>=BACK2Y && yPixel<BACK2Y+(98*5) && xPixel>=BACK2X && xPixel<BACK2X+(128*5-BACK2SKIPX) && BACK2q[15]==1'b1)
	begin
		VGAr=BACK2q[14:10]*8;
		VGAg=BACK2q[9:5]*8;
		VGAb=BACK2q[4:0]*8;
	...
	if(yPixel>=BACK1Y && yPixel<BACK1Y+(98*5) && xPixel>=BACK1X && xPixel<BACK1X+(128*5-BACK1SKIPX) && BACK1q[15]==1'b1)
	begin
		VGAr=BACK1q[14:10]*8;
		VGAg=BACK1q[9:5]*8;
		VGAb=BACK1q[4:0]*8;
...
collsMod mod();
wire [15:0]BACK2q;
ramBACK2 BACK2ram((((yPixel-BACK2Y+BACK2SKIPY)/5)*128 +((xPixel-BACK2X)/5)+1)+(BACK2SKIPX/5),CLOCK,16'd0,0,BACK2q);
wire [15:0]BACK1q;
ramBACK1 BACK1ram((((yPixel-BACK1Y+BACK1SKIPY)/5)*128 +((xPixel-BACK1X)/5)+1)+(BACK1SKIPX/5),CLOCK,16'd0,0,BACK1q);
wire [15:0]PIPEDOWN1q;
ramPIPEDOWN1 PIPEDOWN1ram((((yPixel-PIPEDOWN1Y+PIPEDOWN1SKIPY)/2)*33 +((xPixel-PIPEDOWN1X)/2)+1)+(PIPEDOWN1SKIPX/2),CLOCK,16'd0,0,PIPEDOWN1q);
wire [15:0]PIPEDOWN2q;
ramPIPEDOWN2 PIPEDOWN2ram((((yPixel-PIPEDOWN2Y+PIPEDOWN2SKIPY)/2)*33 +((xPixel-PIPEDOWN2X)/2)+1)+(PIPEDOWN2SKIPX/2),CLOCK,16'd0,0,PIPEDOWN2q);
wire [15:0]PIPEDOWN3q;
ramPIPEDOWN3 PIPEDOWN3ram((((yPixel-PIPEDOWN3Y+PIPEDOWN3SKIPY)/2)*33 +((xPixel-PIPEDOWN3X)/2)+1)+(PIPEDOWN3SKIPX/2),CLOCK,16'd0,0,PIPEDOWN3q);
wire [15:0]pointq;
rampoint pointram((((yPixel-pointY+pointSKIPY)/1)*32 +((xPixel-pointX)/1)+1)+(pointSKIPX/1),CLOCK,16'd0,0,pointq);
wire [15:0]PIPEUP1q;
ramPIPEUP1 PIPEUP1ram((((yPixel-PIPEUP1Y+PIPEUP1SKIPY)/2)*33 +((xPixel-PIPEUP1X)/2)+1)+(PIPEUP1SKIPX/2),CLOCK,16'd0,0,PIPEUP1q);
wire [15:0]PIPEUP2q;
ramPIPEUP2 PIPEUP2ram((((yPixel-PIPEUP2Y+PIPEUP2SKIPY)/2)*33 +((xPixel-PIPEUP2X)/2)+1)+(PIPEUP2SKIPX/2),CLOCK,16'd0,0,PIPEUP2q);
wire [15:0]PIPEUP3q;
ramPIPEUP3 PIPEUP3ram((((yPixel-PIPEUP3Y+PIPEUP3SKIPY)/2)*33 +((xPixel-PIPEUP3X)/2)+1)+(PIPEUP3SKIPX/2),CLOCK,16'd0,0,PIPEUP3q);
wire [15:0]cloud1q;
ramcloud1 cloud1ram((((yPixel-cloud1Y+cloud1SKIPY)/1)*31 +((xPixel-cloud1X)/1)+1)+(cloud1SKIPX/1),CLOCK,16'd0,0,cloud1q);
wire [15:0]cloud2q;
ramcloud2 cloud2ram((((yPixel-cloud2Y+cloud2SKIPY)/1)*31 +((xPixel-cloud2X)/1)+1)+(cloud2SKIPX/1),CLOCK,16'd0,0,cloud2q);
wire [15:0]cloud3q;
ramcloud3 cloud3ram((((yPixel-cloud3Y+cloud3SKIPY)/1)*31 +((xPixel-cloud3X)/1)+1)+(cloud3SKIPX/1),CLOCK,16'd0,0,cloud3q);
