        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Task.Run(() => {
                ...
                using (StreamWriter writer = new StreamWriter(currentProjectFolderPath + "\\IH8Verilog_main.v"))
                {
                    ...
                    writer.WriteLine("module PP2VerilogDrawingController(xPixel,yPixel,VGAr,VGAg,VGAb,mouseX,mouseY,"+String.Join(",",movs.ToArray())+");" + Environment.NewLine);
            ...
            foreach(Shape shape in slide.Content.Drawings.OfType<Shape>())
            {
                ...
                if(shape.Format.Fill.FillType==FillFormatType.Solid)
                {
                    ...
                    if (shape.ShapeType==ShapeGeometryType.Rectangle)
                    {
                        ...
                        {
                            writeSquareShapeColorMoveable(writer, f.Color, getScaledLayout(shape.Layout), tabs, shape.Format.Outline, properties.ContainsKey("BORDER"), allowedTransparencyLevel, properties["NAME"].Replace(" ", "_"));
                        } else
                        {
